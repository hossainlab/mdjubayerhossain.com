          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
            ...
            <div className="order-2 lg:order-1 space-y-6 sm:space-y-8 text-center lg:text-left">
              <div className="space-y-4 sm:space-y-6">
                <div className="inline-flex items-center px-3 sm:px-4 py-2 bg-primary-100 dark:bg-primary-900/30 text-primary-700 dark:text-primary-300 rounded-full text-xs sm:text-sm font-semibold mx-auto lg:mx-0">
                  <span className="w-2 h-2 bg-primary-500 rounded-full mr-2 animate-pulse"></span>
                  <span className="hidden sm:inline">Leading Innovation in Computational Biology</span>
                  <span className="sm:hidden">Innovation in Computational Biology</span>
                </div>
                
                <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 dark:text-white leading-tight">
                  <span className="text-blue-600 dark:text-blue-400 bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-400 dark:to-purple-400" style={{WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text'}}>
                    Data
                  </span>
                  <span className="text-gray-700 dark:text-gray-300">{" "}to{" "}</span>
                  <span className="text-purple-600 dark:text-purple-400 bg-clip-text bg-gradient-to-r from-purple-600 to-green-600 dark:from-purple-400 dark:to-green-400" style={{WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text'}}>
                    Innovation
                  </span>
                </h1>
              ...
              {/* Key Achievements */}
              <div className="grid grid-cols-3 gap-3 sm:gap-4 lg:gap-6 max-w-md mx-auto lg:max-w-none">
                <div className="text-center p-3 sm:p-4 bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm rounded-lg border border-gray-200/50 dark:border-gray-700/50">
                  <div className="text-lg sm:text-xl lg:text-2xl font-bold text-primary-600 dark:text-primary-400">20+</div>
                  <div className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Publications</div>
                </div>
                <div className="text-center p-3 sm:p-4 bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm rounded-lg border border-gray-200/50 dark:border-gray-700/50">
                  <div className="text-lg sm:text-xl lg:text-2xl font-bold text-secondary-600 dark:text-secondary-400">2</div>
                  <div className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Companies</div>
                </div>
                <div className="text-center p-3 sm:p-4 bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm rounded-lg border border-gray-200/50 dark:border-gray-700/50">
                  <div className="text-lg sm:text-xl lg:text-2xl font-bold text-accent-600 dark:text-accent-400">3000+</div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-4 sm:pt-6 justify-center lg:justify-start">
                ...
                <a
                  href="#publications"
                  className="group inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 bg-white/80 dark:bg-gray-800/80 text-gray-700 dark:text-gray-300 border-2 border-gray-300 dark:border-gray-600 hover:border-primary-500 hover:text-primary-600 dark:hover:text-primary-400 dark:hover:border-primary-400 font-semibold rounded-xl backdrop-blur-sm hover:bg-white dark:hover:bg-gray-800 transform hover:-translate-y-1 transition-all duration-300 text-sm sm:text-base"
                >
                  <svg className="w-4 h-4 sm:w-5 sm:h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="order-1 lg:order-2 relative flex justify-center lg:justify-end">
              <div className="relative">
                ...
                <div className="relative w-64 h-64 sm:w-72 sm:h-72 lg:w-80 lg:h-80 mx-auto">
                  {/* Decorative Rings */}
                  <div className="absolute inset-0 rounded-full border-2 sm:border-4 border-blue-200 dark:border-blue-800" style={{animation: 'spin 20s linear infinite'}}></div>
                  <div className="absolute inset-2 sm:inset-4 rounded-full border-2 sm:border-4 border-purple-200 dark:border-purple-800" style={{animation: 'spin 15s linear reverse infinite'}}></div>
                  
                  {/* Profile Image Container */}
                  <div className="absolute inset-4 sm:inset-8 bg-gradient-to-br from-blue-100 to-purple-100 dark:from-blue-900/50 dark:to-purple-900/50 rounded-full flex items-center justify-center shadow-2xl">
                    {/* Placeholder for profile photo */}
                    <div className="w-32 h-32 sm:w-40 sm:h-40 lg:w-48 lg:h-48 bg-gradient-to-br from-blue-500 to-purple-500 rounded-full flex items-center justify-center">
                  ...
                  <div className="hidden sm:block absolute -top-2 sm:-top-4 -right-2 sm:-right-4 w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 bg-blue-500 rounded-full flex items-center justify-center shadow-lg animate-bounce">
                  ...
                  <div className="hidden sm:block absolute -bottom-2 sm:-bottom-4 -left-2 sm:-left-4 w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 bg-purple-500 rounded-full flex items-center justify-center shadow-lg animate-pulse">
                    <svg className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="hidden lg:block absolute top-1/2 -right-6 lg:-right-8 w-8 h-8 lg:w-10 lg:h-10 bg-green-500 rounded-full flex items-center justify-center shadow-lg animate-ping">
